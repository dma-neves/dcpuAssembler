...
**Description**
  ...
  - Given a `.s` file with assembly code, the assembler.py program generates the corresponding bytecode. The generated bytecode can be stored in a file containing raw bytecode (`.binary`) or containing a string with the corresponding 0s and 1s (`.strbinary`).
